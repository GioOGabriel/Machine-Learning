...
def main():
    ...
    with tab1:
        ...
        with col1:
            ...
            education_level = st.selectbox("Educacao", ["Ensino Fundamental", "Ensino Medio", "Graduacao e/ou acima"])
        ...
        with col1:
         ...
         dados = {
             ...
             'EducationLevel': ["Ensino Fundamental", "Ensino Medio", "Graduacao e/ou acima"].index(education_level),
             'BMI': bmi,
